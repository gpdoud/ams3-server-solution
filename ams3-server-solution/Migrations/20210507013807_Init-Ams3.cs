...
{
    public partial class InitAms3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutForRepairDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReturnFromRepairDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RetiredDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SurplusDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResidualValue = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
